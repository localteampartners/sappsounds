...
`sappvault://sappsounds/NAME` (macOS Keychain). Otherwise it's a
...
|---|---|---|---|
| `<!-- FILL IN -->` | <!-- FILL IN --> | <!-- e.g., "1Password > sappsounds > DB_URL" --> | <!-- e.g., "api, worker" --> |
|  |  |  |  |
...
- **Production:** <!-- FILL IN: e.g., "systemd EnvironmentFile=/etc/sappsounds.env", "Fly.io secrets", "Vercel dashboard" -->
