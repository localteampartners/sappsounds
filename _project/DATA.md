...
```
pbpaste | sappvault set sappsounds DATABASE_URL --from-file -
pbpaste | sappvault set sappsounds SUPABASE_SERVICE_ROLE_KEY --from-file -   # Supabase only
```
